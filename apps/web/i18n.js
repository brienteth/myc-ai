...
(function() {
  const translations = {
    en: {
      ...
      depin_sc1_tab: "🏭 Scenario 1: Refinery Pipeline Pressure Isolation",
      depin_sc2_tab: "📡 Scenario 2: Telecom Base Station Offline Microgrid",
    ...
    tr: {
      ...
      depin_sc1_tab: "🏭 Senaryo 1: Rafineri Boru Hattı Basınç İzolasyonu",
      depin_sc2_tab: "📡 Senaryo 2: Telekom Baz İstasyonu Çevrimdışı Mikroşebeke",
