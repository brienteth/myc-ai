...
const MyceliumCanvas = ({
  ...
  useEffect(() => {
    ...
    function activatePulse() {
      ...
      for (let i = 0; i < count; i++) {
        ...
        n.pulsing = true;
        setTimeout(() => { if(n) n.pulsing = false; }, 1400);
      }
    }
      ...
      nodes.forEach((a, i) => {
        nodes.slice(i + 1).forEach(b => {
          ...
          if (dist < connectDist) {
            ...
            const alpha       = bothPulsing ? baseAlpha + 0.25 : baseAlpha;
  ...
  }, [nodeCount, nodeColor, threadColor, bgColor, speed, connectDist, pulseEvery, organic]);
