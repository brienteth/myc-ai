...
## 3. Embed Myca in Python Projects (Python SDK)

You can also use Myca as a standalone Python SDK (`pip install myca`) in your own applications:
...
For complete documentation on all SDK capabilities (LLM generation, local web crawling, session memory, and autonomous software factory), see [Myca Python SDK Documentation](file:///Users/bl10buer/Downloads/myca-private-main/docs/sdk.md).
